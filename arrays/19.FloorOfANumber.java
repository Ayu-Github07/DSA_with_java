...
//Floor of a number means greatest number equal or smaller than the target number.
...
class FloorOfANumber {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The greatest element smaller than or equal to the target is : " + index);
    }
